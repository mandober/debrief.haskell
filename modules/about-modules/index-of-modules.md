# Index of the standard Haskell modules

* Prelude                                         base-4.16.0.0
* *Control*
  * Control.Applicative                           base-4.16.0.0
    - Control.Applicative.Backwards               transformers-0.5.6.2
    - Control.Applicative.Lift                    transformers-0.5.6.2
  * Control.Arrow
  * Control.Category
  * Control.Concurrent
...
* *Data*
  ...
  - Data.Void
  - Data.Word
* Numeric                                         base-4.16.0.0
  - Numeric.Natural                               base-4.16.0.0
* Text
  - Text.Parsec
...
This index includes documentation of the standard Haskell modules.
