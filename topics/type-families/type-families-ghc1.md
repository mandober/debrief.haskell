...
The `family` keyword distinguishes family from standard data declarations. The result kind annotation is optional and, as usual, defaults to `Type` if omitted. An example is:
