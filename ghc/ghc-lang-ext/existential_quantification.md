Existentially quantified data constructors {#existential-quantification}
==========================================
...
The `self` type is hidden from the outside; any attempt to apply
...
There are several restrictions on the ways in which
