Kind polymorphism[]{#type-in-type}
==================================
...
Data families are tricky territory. Their headers are exempt from this
...
Enabled by `PolyKinds`{.interpreted-text role="extension"}, GHC supports
